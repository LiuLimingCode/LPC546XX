...
ADCCH_enum MCP41_ADC[ADC_NUM] = {AD_CH_L__,AD_CH_L_1, AD_CH_M_1,AD_CH_R_1,AD_CH_R__}  ;//设定的通道
uint8 MCP41_Set[ADC_NUM] = {ADC_L_L_Min_8bit ,ADC_L_Min_8bit ,  ADC_M_Min_8bit ,ADC_R_Min_8bit, ADC_R_R_Min_8bit };//各个电感的设定值(对应上面设定的通道号)
