...
/***************** 次要宏定义 *****************/
#define FLASH_SAVE_PRO_MENU     (EEPROM_PAGE_COUNT - 10)                 //菜单数据在FLASH中存储的位置
#define FLASH_SAVE_RAW_MENU     (EEPROM_PAGE_COUNT - 11)                 //菜单数据在FLASH中存储的位置
#define FLASH_SECTOR_SIZE       (EEPROM_PAGE_SIZE * 8)                   //FLASH的存储总字节数
